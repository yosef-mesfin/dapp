...
const configurationData = {
	supported_resolutions: ['1', '60', "240", '1D', '1W', '1M'],
	exchanges: [
        {
		value: 'Bitfinex',
		name: 'Bitfinex',
...
export default {
	...
	getBars: async (symbolInfo: symbolType, resolution: string, periodParams: periodParamsType, onHistoryCallback: any, onErrorCallback: any) => {
